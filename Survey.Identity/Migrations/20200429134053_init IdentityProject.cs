...
{
    public partial class initIdentityProject : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 4, 29, 13, 40, 52, 696, DateTimeKind.Local).AddTicks(95)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 4, 29, 13, 40, 52, 709, DateTimeKind.Local).AddTicks(6722)),
                    CreatedBy = table.Column<Guid>(nullable: true),
                    DisabledOn = table.Column<DateTime>(nullable: true),
                    DisabledBy = table.Column<Guid>(nullable: true),
                    DeletedBy = table.Column<Guid>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    DeletReason = table.Column<string>(maxLength: 250, nullable: true),
                    CreatedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 4, 29, 13, 40, 52, 667, DateTimeKind.Local).AddTicks(9498)),
                    CreatedBy = table.Column<Guid>(nullable: true),
                    Timestamp = table.Column<byte[]>(rowVersion: true, nullable: true),
