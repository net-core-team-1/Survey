...
namespace Survey.Identity.Migrations
{
    ...
    [Migration("20200611193145_adding entity property to role")]
    partial class addingentitypropertytorole
    {
            ...
            modelBuilder.Entity("Survey.Identity.Data.OutBox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        ...
                        .HasDefaultValue(new Guid("04d21804-b82f-4c64-bdff-2ce802f8950e"));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .HasColumnType("datetime2")
                                .HasDefaultValue(new DateTime(2020, 6, 11, 19, 31, 44, 930, DateTimeKind.Local).AddTicks(5185));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .HasColumnName("CreatedOn")
                                .HasColumnType("datetime2")
                                .HasDefaultValue(new DateTime(2020, 6, 11, 19, 31, 44, 858, DateTimeKind.Local).AddTicks(1800));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .HasColumnName("CreatedOn")
                                .HasColumnType("datetime2")
                                .HasDefaultValue(new DateTime(2020, 6, 11, 19, 31, 44, 892, DateTimeKind.Local).AddTicks(792));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .HasColumnName("CreatedOn")
                                .HasColumnType("datetime2")
                                .HasDefaultValue(new DateTime(2020, 6, 11, 19, 31, 44, 936, DateTimeKind.Local).AddTicks(5903));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .HasColumnName("CreatedOn")
                                .HasColumnType("datetime2")
                                .HasDefaultValue(new DateTime(2020, 6, 11, 19, 31, 44, 723, DateTimeKind.Local).AddTicks(5621));
