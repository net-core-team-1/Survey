...
namespace Survey.Identity.Migrations
{
    ...
    [Migration("20200526092835_adding outbox table with its mapping")]
    partial class addingoutboxtablewithitsmapping
    {
            ...
            modelBuilder.Entity("Survey.Identity.Data.OutBox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("1a72cd9b-d2f3-4bd4-a91f-bd4c26efc855"));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 28, 35, 381, DateTimeKind.Local).AddTicks(7939));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 28, 35, 369, DateTimeKind.Local).AddTicks(3564));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 28, 35, 328, DateTimeKind.Local).AddTicks(6346));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 28, 35, 342, DateTimeKind.Local).AddTicks(9286));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 28, 35, 390, DateTimeKind.Local).AddTicks(232));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 28, 35, 299, DateTimeKind.Local).AddTicks(8317));
