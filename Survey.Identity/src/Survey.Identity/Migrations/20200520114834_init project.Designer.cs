...
namespace Survey.Identity.Migrations
{
    ...
    [Migration("20200520114834_init project")]
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .HasDefaultValue(new DateTime(2020, 5, 20, 11, 48, 33, 536, DateTimeKind.Local).AddTicks(4220));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 20, 11, 48, 33, 523, DateTimeKind.Local).AddTicks(9803));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 20, 11, 48, 33, 480, DateTimeKind.Local).AddTicks(5826));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 20, 11, 48, 33, 497, DateTimeKind.Local).AddTicks(2916));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 20, 11, 48, 33, 448, DateTimeKind.Local).AddTicks(9931));
