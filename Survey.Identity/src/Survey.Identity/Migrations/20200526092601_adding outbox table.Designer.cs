...
namespace Survey.Identity.Migrations
{
    ...
    [Migration("20200526092601_adding outbox table")]
    partial class addingoutboxtable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Survey.Identity.Events.BaseEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Survey.Identity.Data.OutBox.OutboxMessage", b =>
                {
                    b.HasOne("Survey.Identity.Events.BaseEvent", "Event")
                        .WithMany()
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 26, 0, 572, DateTimeKind.Local).AddTicks(2385));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 26, 0, 559, DateTimeKind.Local).AddTicks(2442));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 26, 0, 517, DateTimeKind.Local).AddTicks(2861));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 26, 0, 531, DateTimeKind.Local).AddTicks(9329));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 26, 0, 580, DateTimeKind.Local).AddTicks(3507));
                    ...
                    b.OwnsOne("Survey.Identity.Domain.CreateInfo", "CreateInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("CreatedOn")
                                ...
                                .ValueGeneratedOnAdd()
                                .HasColumnName("CreatedOn")
                                .HasDefaultValue(new DateTime(2020, 5, 26, 9, 26, 0, 488, DateTimeKind.Local).AddTicks(4934));
