...
namespace Identity.Api.Identity.Domain.Roles.Events
{
    public class RoleRegistredEvent : AcceptedEventBase<RegisterRoleCommand>
    {
        ...
        public RoleRegistredEvent(string name, string description, Guid createdBy, Guid appServiceId)
        ...
        {
            return new RoleRegistredEvent(command.Name, command.Description, command.CreatedBy, command.AppServiceId);
        }
    }
}
