...
{
    public class UnregisterRoleFeatureCommandHandler : ICommandHandler<UnregisterRoleFeatureCommand>
    {
        private readonly IRoleService _roleService;
        private readonly IFeatureRepository _featureRepository;

        public UnregisterRoleFeatureCommandHandler(IRoleService roleService,
              IFeatureRepository featureRepository)
        {
            _roleService = roleService;
            _featureRepository = featureRepository;
        }
        public async Task<Result> Handle(UnregisterRoleFeatureCommand command)
        {
            ...
            role.RemoveFeature(command.FeatureId);
