        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 9, 2, 21, 44, 805, DateTimeKind.Local).AddTicks(6851)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 9, 2, 21, 44, 716, DateTimeKind.Local).AddTicks(7403)),
                    CreatedBy = table.Column<Guid>(nullable: true),
                    DisabledOn = table.Column<DateTime>(nullable: true),
                    DisabledBy = table.Column<Guid>(nullable: true),
                    Disabled = table.Column<bool>(nullable: true, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssociatedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 9, 0, 21, 44, 781, DateTimeKind.Utc).AddTicks(5515))
                },
                constraints: table =>
                {
